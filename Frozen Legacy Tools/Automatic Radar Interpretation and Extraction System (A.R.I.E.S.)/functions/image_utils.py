...
def load_and_preprocess_image(image_path_str, preprocessing_params=None):
    ...
    try:
        ...
        # Increase PIL's maximum image size limit for large radar images
        # Default limit is ~89MP, we'll set it to ~200MP for radar data processing
        Image.MAX_IMAGE_PIXELS = 200000000
        
        # Suppress decompression bomb warnings specifically for known large radar images
